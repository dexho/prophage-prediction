...
search = ['phage', 'terminase', 'capsid', 'tail', 'fiber', 'sheath', 'connector', 'portal', 'tube', 'baseplate', 'plate', 'coat', 'lysin', 'occluden', 'Phage', 'Terminase', 'Capsid', 'Tail', 'Fiber', 'Sheath', 'Connector', 'Portal', 'Tube', 'Baseplate', 'Plate', 'Coat', 'Lysin', 'Occluden']
            ...
            for feature in record.features:
                if feature.type == 'CDS':
                    try:
                        ...
                        # print(feature.location.start, "|", desc)
                        phage_r = False
                        for s in search:
                            if s in desc:
                                print("***********", feature.location.start, "|", s, "|", desc, "|")
                                phage_r = True
                                for r in exclude:
                                    if r in desc:
                                        phage_r = False
